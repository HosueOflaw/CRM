...
Public Class FRM_ADD_USER
    ...
    Sub ADD_NEW_USER()
        ...
        CMD = New SqlCommand("INSERT INTO [dbo].[EMPLOYEE] (NAME,DATE_recruitment,PASS,DEPARTMENT,CODE,NUM,IS_VOKE,ACTIVEE,INTERNAL,SWITCH,NAME_EN, RESPON)
                              VALUES
                             (@NAME,@DATE_recruitment,@PASS,@DEPARTMENT,@CODE,@NUM,@IS_VOKE,@ACTIVEE,@INTERNAL,
                             @SWITCH,@NAME_EN, @RESPON)", SQLCON_TELE)
        ...
        CMD.Parameters.Add(New SqlParameter("@RESPON", SqlDbType.NVarChar)).Value = If(TXT_DEP.Text = "SEC", "SEC", 0)
